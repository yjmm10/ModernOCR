 ...
 * @LastEditTime: 2022-03-11 14:34:14
 * @LastEditors: Petrichor
 * @Description:  
 * @FilePath: \ModernOCR\modules\core\operators.h
 * 版权声明
 */
...
namespace ModernOCR{
    namespace op
    {
        ...
        inline void ResizeBySize(const cv::Mat &src, cv::Mat &dst, int dstWidth, int dstHeight){
